 ...
 */
public class NgramTextView extends IndicTextView implements NgramInterface {
    ...
    private void initAttrs(AttributeSet attrs, int defStyle) {
        TypedArray a = getContext().getTheme().obtainStyledAttributes(
                attrs,
                R.styleable.NgramTextView,
                defStyle, defStyle
        );

        try {

            this.mNgramNValue = a.getInteger(R.styleable.NgramTextView_ngramNValue, -1);
            this.mNgramType = a.getInteger(R.styleable.NgramTextView_ngramType,
                    NgramTextView.DEFAULT_NGRAM_TYPE);
        } catch (Exception e) {
